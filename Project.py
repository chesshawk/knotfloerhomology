...
def all_bijections (a):
    '''This method is tricky. It takes the input a, which this program automatically generates given a tangle. a is just a list of list of sets, where each list of sets is a list of all subsets of T (where algebra is generated by partial bijections of T). Anytime this method is called, call it as all_bijections(a). It will return for you all the partial bijections of T.'''
    all_bij = []
